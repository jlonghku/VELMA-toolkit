...
def find_upstream(acc, fdir,threshold=None,return_value=False,return_main=False,tmp_acc=None):
    ...
    if threshold is None:
        ...
        best_criterion_value = upstream_points[0][0] if upstream_points else 0.0
...
def subdivide_catchments(asc_file, col, row, num_processors, num_subbasins, method='equal', crs="EPSG:26910", is_plot=False,target_size=None,save_dir=None):
    if num_subbasins <=1:
        return ''
